  ...
  namespace umbp
  {
    ...
    namespace protobuf_umbp_5fconfig_2eproto
    {
      ...
      static const ::google::protobuf::internal::MigrationSchema schemas[] = {
          ...
          {45, -1, sizeof(PropogateConfig)},
          {51, -1, sizeof(CostConfig)},
          {60, -1, sizeof(Config)},
      };
      ...
      void AddDescriptorsImpl()
      {
        ...
        static const char descriptor[] = {
            ...
            "ane_width\030\007 \001(\001\"e\n\017PropogateConfig\022%\n\003fp"
            "b\030\001 \001(\0132\030.planning.umbp.FpbConfig\022+\n\006sam"
            "ple\030\002 \001(\0132\033.planning.umbp.SampleConfig\"\335"
            "\001\n\nCostConfig\0221\n\nefficiency\030\001 \001(\0132\035.plan"
            "ning.umbp.EfficiencyCost\022)\n\006safety\030\002 \001(\013"
            "2\031.planning.umbp.SafetyCost\022%\n\004user\030\003 \001("
            "\0132\027.planning.umbp.UserCost\0221\n\nnavigation"
            "\030\004 \001(\0132\035.planning.umbp.NavigationCost\022\027\n"
            "\017discount_factor\030\005 \001(\001\"\223\001\n\006Config\022\014\n\004nam"
            "e\030\001 \001(\t\022\017\n\007version\030\002 \001(\t\022\016\n\006status\030\003 \001(\t"
            "\022\'\n\004cost\030\004 \001(\0132\031.planning.umbp.CostConfi"
            "g\0221\n\tpropogate\030\005 \001(\0132\036.planning.umbp.Pro"
            "pogateConfigb\006proto3"};
          ...
          _cached_size_(0)
    {
      ...
      ::memcpy(&s_sample_distance_, &from.s_sample_distance_,
               reinterpret_cast<char *>(&lane_width_) -
                   reinterpret_cast<char *>(&s_sample_distance_) + sizeof(lane_width_));
      // @@protoc_insertion_point(copy_constructor:planning.umbp.SampleConfig)
    }

    void SampleConfig::SharedCtor()
    {
      ::memset(&s_sample_distance_, 0, reinterpret_cast<char *>(&lane_width_) - reinterpret_cast<char *>(&s_sample_distance_) + sizeof(lane_width_));
      _cached_size_ = 0;
    }
...
#undef DO_
    ...
    void Config::SharedCtor()
    {
      ...
      version_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
      status_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
      ::memset(&cost_, 0, reinterpret_cast<char *>(&propogate_) - reinterpret_cast<char *>(&cost_) + sizeof(propogate_));
      _cached_size_ = 0;
    }
